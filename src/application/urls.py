...
from application.views.public.public_index import PublicIndex, PublicUrl
...
from application.views.admin.page import PageList, PageCreate, PageEdit, PageDelete
from application.views.admin.menu import MenuOrder, MenuOrderData
...
app.add_url_rule('/<url_name>', 'public_url', view_func=PublicUrl.as_view('public_url'), methods=['GET'])
app.add_url_rule('/admin/page_list', 'page_list', view_func=PageList.as_view('page_list'), methods=['GET'])
app.add_url_rule('/admin/page_create', 'page_create', view_func=PageCreate.as_view('page_create'), methods=['GET', 'POST'])
app.add_url_rule('/admin/page_edit/<int:page_id>', 'page_edit', view_func=PageEdit.as_view('page_edit'), methods=['GET', 'POST'])
app.add_url_rule('/admin/page_delete/<int:page_id>', 'page_delete', view_func=PageDelete.as_view('page_delete'), methods=['POST'])

app.add_url_rule('/admin/menu_order', 'menu_order', view_func=MenuOrder.as_view('menu_order'), methods=['GET', 'POST'])
app.add_url_rule('/admin/menu_order/data', 'menu_order_data', view_func=MenuOrderData.as_view('menu_order_data'), methods=['POST'])
